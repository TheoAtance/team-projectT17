...
/**
 * Presenter for Google Login use case.
 * Since Google login can be triggered from either login or register view,
 * this presenter can update error states in both views.
 */
