...
/**
 * Controller for Google Login use case.
 * Note: Google login can be triggered from either RegisterView or LoginView,
 * so this controller is shared/reused by both.
 */
