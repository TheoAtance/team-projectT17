...
/**
 * The ViewModel for our CA implementation. This class delegates work to a PropertyChangeSupport
 * object for managing the property change events.
 *
...
public class ViewModel<T> {
   ...
   * kinds of property changes.
   * <p/>
   * For example, the LoggedInView listens for two kinds of property changes; it can use the
   * property name to distinguish which property has changed.
   *
