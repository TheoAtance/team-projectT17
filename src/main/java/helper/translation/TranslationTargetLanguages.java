 ...
 * <p>
 * Keys in LANGUAGE_CODES are the labels shown in the combo box. They are written in (or close to)
 * each language's own name.
 * <p>
 * Values are language codes understood by the TranslationService (e.g., DeepL-style codes like
 * "EN-US", "FR", "JA", "ZH-HANS", etc.).
 */
