 ...
 * the number of columns adjusts based on window width. This component is now purely for display and
 * rendering, it does not hold the list of restaurants internally.
 */
