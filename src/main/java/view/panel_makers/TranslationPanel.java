...
/**
 * Card-style panel for showing original and translated reviews. Designed to match
 * ReviewPanel/RestaurantPanel ui style.
 */
public class TranslationPanel extends JPanel {
  ...
  /**
   * Utility so TranslationView can style external components (e.g. the Back button) with the same
   * font logic.
   */
