...
public class RestaurantPanel extends JPanel {
  ...
  protected void paintComponent(Graphics g) {
    ...
    g2.fill(
        new RoundRectangle2D.Double(0, 0, CARD_WIDTH, CARD_HEIGHT, CORNER_RADIUS, CORNER_RADIUS));

    g2.setColor(new Color(0, 0, 0, 20));
    g2.fill(
        new RoundRectangle2D.Double(2, 2, CARD_WIDTH, CARD_HEIGHT, CORNER_RADIUS, CORNER_RADIUS));

    g2.setClip(
        new RoundRectangle2D.Double(0, 0, CARD_WIDTH, IMAGE_HEIGHT, CORNER_RADIUS, CORNER_RADIUS));
  ...
  private void drawStar(Graphics2D g2, int x, int y, Color color) {
    g2.setColor(color);
    final int[] xPoints = {x + 8, x + 10, x + 15, x + 11, x + 13, x + 8, x + 3, x + 5, x + 1,
        x + 6};
  ...
  /**
   * Data class for restaurant display information. No entity dependencies - just display strings
   * and primitives.
   */
