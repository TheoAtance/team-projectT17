...
/**
 * The gateway for Firebase Auth. The methods below (apart from logout) should return the User's uid.
 */
public interface IAuthGateway {
     ...
     * @throws AuthFailureException if registration fails (e.g., email already in use, weak password).
     */
