...
/**
 * Interactor for the Google Login/Registration Use Case (OAuth). Handles the logic for checking if
 * a Google-authenticated user is new (registration) or existing (login).
 */
