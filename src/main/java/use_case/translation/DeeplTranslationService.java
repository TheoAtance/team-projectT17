...
/**
 * - Translates a list of strings using DeepL and returns results in the same order. - Auto-detects
 * the source language for each string. - Optional HTML mode preserves tags (e.g., <b>, <i>) during
 * translation.
 *
 **/
