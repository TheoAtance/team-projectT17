...
public class ListSearchInteractorTest {
    ...
    public void testSearchWithMatchingQuery() {
        ...
        assertEquals("Should return 1 matching restaurant", 1, testPresenter.getOutputData().getFilteredRestaurants().size());
    ...
    public void testSearchSortsByRatingToReviewRatio() {
        ...
        assertEquals("First result should be Pizza Parlor (higher ratio)", "Pizza Parlor", results.get(0).getName());
        assertEquals("Second result should be Pasta Palace (lower ratio)", "Pasta Palace", results.get(1).getName());
    }
    ...
    public void testSearchWithException() {
        ...
        // Assert
        assertTrue("Present error should be called when exception occurs", testPresenter.isPresentErrorCalled());
        assertFalse("Present results should not be called when exception occurs", testPresenter.isPresentResultsCalled());
    ...
    private static class TestRestaurantDataAccess implements IRestaurantDataAccess {
        ...
        private Restaurant createRestaurant(String id, String name, String type, double rating, int ratingCount) {
