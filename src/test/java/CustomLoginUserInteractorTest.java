...
/**
 * Unit tests for CustomLoginUserInteractor using Mockito, which auto-generates fake objects at
 * runtime to test only the interactor's logic. Tests all success and failure paths for user login.
 */
...
class CustomLoginUserInteractorTest {
  ...
  void testEmailNotFound() {
    // Arrange
    CustomLoginInputData inputData = new CustomLoginInputData("nonexistent@example.com",
        TEST_PASSWORD);
